# Python-JPEG
Fast JPEG compression implementation, able to compress to 25% of original size without very visible loss for both portraits and landscapes.
25% corresponds to q = 2. Program is written with numba jit to greatly reduce runtime.
